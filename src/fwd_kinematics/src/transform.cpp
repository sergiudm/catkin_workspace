...
Eigen::Matrix4d T_base2tool(Eigen::VectorXd thetas) {
  Eigen::Vector4d l1 = {M_PI / 2.0, 0, 0.1283 + 0.115, thetas[0]};
  Eigen::Vector4d l2 = {M_PI, 0.280, 0.030, thetas[1] + M_PI / 2.0};
  Eigen::Vector4d l3 = {M_PI / 2.0, 0, 0.020, thetas[2] + M_PI / 2.0};
  Eigen::Vector4d l4 = {M_PI / 2.0, 0, 0.140 + 0.105, thetas[3] + M_PI / 2.0};
  Eigen::Vector4d l5 = {M_PI / 2.0, 0, 0.0285 + 0.0285, thetas[4] + M_PI};
  Eigen::Vector4d l6 = {0, 0, 0.105 + 0.130, thetas[5] + M_PI / 2.0};
